...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen bg-gradient-hero relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-gradient-to-br from-luxury-black via-luxury-black to-luxury-gold/10 opacity-30"></div>
      
      <div className="container mx-auto px-4 pt-32 pb-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Hero Content */}
          <div className="animate-fade-in">
            <div className="inline-flex items-center px-4 py-2 bg-card/10 backdrop-blur-sm border border-luxury-gold/20 rounded-full mb-6">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold mb-6 leading-tight">
              ...
              <br />
              <span className="heading-luxury">Contábeis</span>
              <br />
            ...
            <div className="grid grid-cols-3 gap-6 mb-10">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-300 font-medium">Transparência</p>
              </div>
              <div className="text-center">
                <div className="bg-luxury-gold/20 backdrop-blur-sm p-4 rounded-lg mb-3 inline-block">
                  <TrendingUp className="h-6 w-6 text-luxury-gold" />
                </div>
                <p className="text-sm text-gray-300 font-medium">Excelência</p>
              </div>
              <div className="text-center">
                <div className="bg-luxury-gold/20 backdrop-blur-sm p-4 rounded-lg mb-3 inline-block">
                  <Users className="h-6 w-6 text-luxury-gold" />
                </div>
                <p className="text-sm text-gray-300 font-medium">Confiabilidade</p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative card-luxury p-8 bg-card/95 backdrop-blur-sm">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-2xl font-bold text-luxury-gold">Nossos Serviços</h3>
